...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->lang               = $lang;
        if ($this->lang != 'en_GB' && file_exists(dirname(__FILE__).'uploader/lang') && file_exists(dirname(__FILE__).'uploader/lang/class.upload.' . $lang . '.php')) {
            $translation = null;
            include(dirname(__FILE__).'uploader/lang/class.upload.' . $lang . '.php');

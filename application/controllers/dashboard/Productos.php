...
class Productos extends CI_Controller {
	...
	public $sizes = [
				            ...
				            'principal_y'   => 450
				           	// 'thumbs_x'      => 85,
				            // 'thumbs_y'      => 100,
				            // 'medium_x'      => 160,  //med. para 4 columnas
				            // 'medium_y'      => 160,
				            // 'principal_x'   => 370,
				            // 'principal_y'   => 450
				        ];
	...
	public function editar() {
		...
		$validaciones = array('categoria_id','nombre','url','orden','resumen','seo_title','seo_description','seo_keywords');
	...
	public function nuevo() {
		...
		$validaciones = array('categoria_id','nombre','url','codigo','resumen','NOTfiles[]','orden','seo_title|max_length[150]','seo_description|max_length[150]','seo_keywords');
		if(!empty($_POST)){

                            ...
                            <form>
                             <tr>
                                <div class="blog-post  wow fadeInUp">
                                        <a href="<?=base_url('servicios/')?>{url_id}"><img class="img-responsive" src="files/servicios/{imagen}" alt="{imagen_title}"></a>
                                        <h1><a href="<?=base_url('servicios/')?>{url_id}">{nombre}</a></h1>
                                </div>
                            </tr>
                            </form>
                        </div> <!-- fin col-md-4 -->

                    ...
                    <nav class="yamm megamenu-horizontal" role="navigation">
                        <ul class="nav">
                            ...
                            <li class="dropdown menu-item">
                                <a href="<?=base_url('merchandising/')?>{url}-{id}" class="dropdown-toggle" data-toggle=""><i class=""></i>{nombre}</a>
                            </li>
                            {/menu}
                        </ul>
                    </nav>
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        <a href="<?=base_url('merchandising/')?>{url}"><img  src="assets/frontend/images/blank.gif" data-echo="{ruta}" alt="{imagen_title}"></a>
                                                    </div>
                                                    <!-- /.image -->          
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="<?=base_url('merchandising/')?>{url}">{nombre}</a></h3>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        <a href="<?=base_url('merchandising/')?><?=$value['url']?>"><img  src="assets/frontend/images/blank.gif" data-echo="<?=$value['ruta']?>" alt="<?=$value['nombre']?>"></a>
                                                    </div>
                                                </div>
                                                <div class="product-info text-center">
                                                    <h3 class="name"><a href="<?=base_url('merchandising/')?><?=$value['url']?>"><?=$value['nombre']?></a></h3>
                                                    <div class="description"></div>
                                                ...
                                                <div class="cart clearfix animate-effect text-center">
                                                    <a class="btn btn-primary btn-detalle" href="<?=base_url('merchandising/')?><?=$value['url']?>-<?=$value['id']?>/detalle">VER DETALLE</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

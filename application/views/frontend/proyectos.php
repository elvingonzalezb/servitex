            ...
            <div class="container">
                ...
                <div style="background-image:url(files/secciones/<?=$banner['imagen']?>); width: 100%;left: 0;top: 0;height: 100%;"  class="dez-bnr-inr overlay-black-middle">
                    <div class="container">
                        <div class="dez-bnr-inr-entry">
                            <h1 class="text-white h1-custom">Proyectos</h1>
                        </div>
                    </div>
                </div>
                <?php }?>
                ...
                <div class="breadcrumb-inner">
                    <ul class="list-inline list-unstyled">
                        ...
                        <li class='active'>Galeria Proyectos</li>
                    </ul>
        ...
        <div class="container">
            <div class="row  outer-bottom-vs">
                <div class="blog-page">
                    ...
                    <div class="col-md-12">
                      <h2><center>GALERIA DE PROYECTOS</center></h2>
                        {dataset}
                        <div class="col-md-4">
                            <form>
                             <tr>
                                <div class="blog-post  wow fadeInUp">
                                        <a href="<?=base_url('galerias_proyecto/')?>{url_id}"><img class="img-responsive" src="files/proyectos/{imagen}" alt="{imagen_title}"></a>
                                        <h1><a href="<?=base_url('galerias_proyecto/')?>{url_id}">{nombre}</a></h1>
                                </div>
                            </tr>
                            </form>
                        </div> <!-- fin col-md-4 -->

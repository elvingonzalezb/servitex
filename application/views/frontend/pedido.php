			...
			<div class="shopping-cart">
				<div class="col-md-12 col-sm-12 shopping-cart-table ">
					...
					<?php if (count($carrito)>0): ?>
						<form action="<?=base_url('pedido/continuar')?>" method="post" id="form-continuar-compra">
								...
								<table class="table table-bordered">
									...
									foreach ($carrito as $key => $item): ?>
										<tr>
											...
											<td class="cart-product-grand-total"><span class="cart-grand-total-price" id="new_subtotal_<?=$key?>"><?=dataConfig('moneda').number_format($item['item_subtotal'],2)?></span></td>
									...
									<?php endforeach ?>
										<tr>
											<td class="cart-product-grand-total" colspan="5"><span class="cart-grand-total-price pull-right"> TOTAL </span></td>
											<td class="cart-product-grand-total"><span class="cart-grand-total-price" id="new_total"><?=dataConfig('moneda').number_format($total,2)?></span></td>
										...
										<tr>
											<td colspan="7">
												<div class="shopping-cart-btn">
													...
													<button type="submit" id='continuar_compra' class="btn btn-upper btn-primary pull-right outer-right-xs">Continuar Compra</button>
													</span>
												</div>
												<!-- /.shopping-cart-btn -->
											</td>

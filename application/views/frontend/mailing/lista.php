    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Hemos recibido un mensaje desde el formulario de contacto.
            </td>
          </tr>
         <!--  <tr>
            <td class="button">
            ...
            <tr>
              <td class="item-table">
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td cellspacing="0" cellpadding="0">1</td>
                  ...
                  <tr>
                   <td cellspacing="0" cellpadding="0">2</td>
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td>2</td>

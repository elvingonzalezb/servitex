<?php $this->load->view("dashboard/includes/breadcrumbs", array('titulo'=>'Editar Banner')); ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <div style="position: relative;text-align: right;padding-bottom: 15px;">
                    <a class="btn" href="dashboard/galeria_solo_fotos/listaFoto"><i style="margin-right:5px;" class="fa fa-chevron-left"></i><u>Regresar al listado</u></a>
                    <div class="clearfix"></div>
                </div>
                <?=$this->session->flashdata('message')?>
                <div class="panel-body p-b-25">
                    <form class="form-horizontal" role="form" action="dashboard/galeria_solo_fotos/editarFoto/<?=( !empty($dataset['id']) ? $dataset['id'] : 0)?>" method="post" enctype="multipart/form-data" id="formGaleriaFotos">

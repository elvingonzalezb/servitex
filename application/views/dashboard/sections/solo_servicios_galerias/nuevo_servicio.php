        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body p-b-25">
                    <form class="form-horizontal" role="form" action="dashboard/solo_servicios_galerias/nuevoServicio" method="post" enctype="multipart/form-data" id="formServicios">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="files[]" id="fileuploader" multiple required>

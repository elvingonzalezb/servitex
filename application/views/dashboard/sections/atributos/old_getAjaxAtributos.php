...
<div class="form-group">
	...
	<div class="col-sm-10">
		<select class="form-control select<?php echo $atributo['id'] ?>">
...
<div class="form-group">
	...
	<div class="col-sm-10">
		<input type="number" class="form-control" name="cantidad" id="cantidad" min="0" step="1">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-10">
		<input type="number" class="form-control" name="precio_oferta" id="precio_oferta" min="0" step="0.01">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-10">
		...
		<input type="hidden" id="datos_atributos" name="datos_atributos">
	</div>
</div>
<script>
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if(se_agrego=="1")
                {
                    ...
                    str += '<td align="center" valign="middle"><a href="javascript:quitarPrecioLista(\''+atributos_id+'\')" style="color:red">ELIMINAR</a></td>';
                    str += '</tr>';

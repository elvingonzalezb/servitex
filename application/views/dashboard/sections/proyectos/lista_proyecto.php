    ...
    <div class="page-body">
        <div class="panel panel-default">
                <div class="panel-heading">GALERÍA DE PROYECTOS</div>
                    ...
                    <table class="table table-striped table-hover js-exportable dataTable" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr id="fila-<?=$value['id']?>">
                                    ...
                                    <td class="center">
                                        <a class="btn btn-info" href="dashboard/proyectos/editarProyecto/<?=$value['id']?>">
                                            <i class="glyphicon glyphicon-edit icon-white"></i>
                                            Editar
                                        </a>
                                        <a class="btn btn-danger" href="javascript:eliminarItem(<?=$value['id']?>,'proyectos/deleteProyecto');">
                                            <i class="glyphicon glyphicon-trash icon-white"></i>
                                            Borrar
                                        </a>
                                        <?php 
                                            $href = 'dashboard/proyectos/listaTrabajo/'.$value['id'];
                                            $texto = 'Trabajos';
                                        ?>

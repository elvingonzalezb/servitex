        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <div style="position: relative;text-align: right;padding-bottom: 15px;">
                    <a class="btn" href="dashboard/proyectos/listaProyecto"><i style="margin-right:5px;" class="fa fa-chevron-left"></i><u>Regresar a Proyectos</u></a>
                    <div class="clearfix"></div>
                </div>                
                <?= $this->session->flashdata('message')?>
                <div class="panel-body p-b-25">
                    <form class="form-horizontal" role="form" action="dashboard/proyectos/nuevoProyecto" method="post" enctype="multipart/form-data" id="formProyectos">   

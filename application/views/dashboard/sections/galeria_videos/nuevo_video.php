    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <?php if($id_album!='0'){?>
                    <a class="btn" href="dashboard/galeria_videos/lista_video/<?=$id_album?>"><i style="margin-right:5px;" class="fa fa-chevron-left"></i><u>Regresar a los Videos</u></a>
               <?php } else { ?>
                    <a class="btn" href="dashboard/galeria_videos/lista_album"><i style="margin-right:5px;" class="fa fa-chevron-left"></i><u>Regresar al Álbum</u></a>
                <?php } ?>

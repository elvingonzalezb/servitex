        <div class="page-body">
            <div class="panel panel-default">
                    <div class="panel-heading">Galeria de Albumes de Video</div>
                            ...
                            <?php foreach ($dataset as $key => $value): ?>
                                <div class="col-sm-2 m-b-30" id="fila-<?=$value['id']?>">
                                    ...
                                    <table align="center">
                                            <tr>
                                                <td>
                                                    <a href="dashboard/galeria_videos/editar_album/<?=$value['id']?>" class="btn btn-info"><i class="glyphicon glyphicon-edit icon-white"></i>Editar</a></td>
                                                <td>

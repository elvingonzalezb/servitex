        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <div style="position: relative;text-align: right;padding-bottom: 15px;">
                    <a class="btn" href="dashboard/categorias/lista<?=( !empty($dataset['padre_id']) ? '/'.$dataset['padre_id'] : '')?>"><i style="margin-right:5px;" class="fa fa-chevron-left"></i><u>Regresar a Categorias</u></a>
                ...
                <div class="panel-body p-b-25">
                    <form class="form-horizontal" action="dashboard/categorias/editar/<?=( !empty($dataset['id']) ? $dataset['id'] : 0)?>" method="post" enctype="multipart/form-data" id="formCategoria">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="resumen" <?=in_array('resumen', $requerid)? 'required':''; ?> value="<?=( ! empty($dataset['resumen']) ? $dataset['resumen'] : '')?>">

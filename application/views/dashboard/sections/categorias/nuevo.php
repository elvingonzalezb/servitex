                    ...
                    <form class="form-horizontal" action="dashboard/categorias/nuevo" method="post" enctype="multipart/form-data" id="formCategoria">
                        ...
                        <div class="form-group" id="categorias" >
                            ...
                            <!-- class="selectpicker form-control show-tick"  -->
                                <select name="padre_id" data-placeholder="Seleccionar" class="form-control chosen-select" <?=in_array('padre_id', $requerid)? 'required':''; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="resumen" value="" <?=in_array('resumen', $requerid)? 'required':''; ?>>

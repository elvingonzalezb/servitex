    ...
    <div class="page-body">
        <div class="panel panel-default">
                ...
                <div style="position: relative;text-align: right;padding-bottom: 15px;">
                    <a class="btn" href="dashboard/servicios/listaCategoria"><i class="fa fa-chevron-left"></i>Regresar a la Categoria</a>
                    <a class="btn" href="dashboard/servicios/nuevoServicio/<?=$id_categoria?>"><i class="fa fa-plus"></i>Nuevo Servicios</a>
